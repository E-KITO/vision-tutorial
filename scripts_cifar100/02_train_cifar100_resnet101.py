...
from model import Resblock, get_ResNet101
...
def main():
    ...
    # 2. モデル、損失関数、最適化関数の定義
    net = get_ResNet101(Resblock, num_classes=100).to(device)
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        if epoch_test_acc > best_acc:
            ...
            torch.save(net.state_dict(), './output/best_resnet101_cifar100.pth')
